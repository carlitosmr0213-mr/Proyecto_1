...
public class CrudDoctor extends AbstractCrud<Doctor> {
    ...
    protected Doctor createInstance() {
        String firstName = JOptionPane.showInputDialog(null,
                ...
                "Agregar registro de Doctor", JOptionPane.INFORMATION_MESSAGE);
        ...
        String medicalLicense = JOptionPane.showInputDialog(null,
                "Digite el número de registro médico:",
                "Agregar registro de Doctor", JOptionPane.INFORMATION_MESSAGE);

        String yearsStr = JOptionPane.showInputDialog(null,
                "Digite los años de experiencia del doctor:",
                "Agregar registro de Doctor", JOptionPane.INFORMATION_MESSAGE);
        int yearsOfExperience = Integer.parseInt(yearsStr);

        return new Doctor(firstName, lastName, idNumber, email, birthDate,
                          specialty, medicalLicense, yearsOfExperience);
    }
    ...
    protected boolean updateRecord(Doctor t) {
        for (Doctor doctor : this.listaDoctor) {
            if (doctor.getId() == t.getId()) {
                ...
                if (t.getEmail()             != null) doctor.setEmail(t.getEmail());
                if (t.getBirthDate()         != null) doctor.setBirthDate(t.getBirthDate());
